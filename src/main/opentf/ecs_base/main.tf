...
#   tags             = [ "zookeeper", "yarn", "tez", "hbase" ]
#   hostname         = "base-04.metal.zndx.org"
#   plan             = local.device_plan_base
#   metro            = "da"
#   operating_system = "rhel_8"
#   billing_cycle    = "hourly"
...
resource "cloudflare_record" "ecs_master_01_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-master-01.dev.metal"
  value   = equinix_metal_device.ecs_master_01.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}
...
resource "cloudflare_record" "ecs_master_02_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-master-02.dev.metal"
  value   = equinix_metal_device.ecs_master_02.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}

resource "cloudflare_record" "ecs_master_03_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-master-03.dev.metal"
  value   = equinix_metal_device.ecs_master_03.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}

resource "cloudflare_record" "ecs_worker_01_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-worker-01.dev.metal"
  value   = equinix_metal_device.ecs_worker_01.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}
...
resource "cloudflare_record" "ecs_worker_02_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-worker-02.dev.metal"
  value   = equinix_metal_device.ecs_worker_02.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}
...
resource "cloudflare_record" "ecs_worker_03_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-worker-03.dev.metal"
  value   = equinix_metal_device.ecs_worker_03.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}

resource "cloudflare_record" "ecs_worker_04_dns" {
  zone_id = local.cloudflare_zone_id
  name    = "ecs-worker-04.dev.metal"
  value   = equinix_metal_device.ecs_worker_04.access_public_ipv4
  type    = "A"
  ttl     = 600
  proxied = false
}
